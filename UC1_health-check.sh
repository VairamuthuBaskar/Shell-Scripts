#	Use Case - Building End to End Shell Script (Health Check --> Installation --> Tests -->  Results)
#	At the end of this file it calls another bash file(install-run.sh) to install softwares, run the Tests and upload to S3 buckets
#	Approach:  Whenever I get new machine --> Do run shell script  -->  Release machine

# Health Checks for the machines
